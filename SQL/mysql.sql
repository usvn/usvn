ALTER TABLE `usvn_files` CHANGE `files_id` `files_id` INT( 11 ) NOT NULL AUTO_INCREMENT ;
...
ALTER TABLE `usvn_properties` CHANGE `properties_id` `properties_id` INT( 11 ) NOT NULL AUTO_INCREMENT ;
