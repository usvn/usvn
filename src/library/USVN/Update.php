...
class USVN_Update
{
	...
	static public function runUpdate()
	{
		...
		else if ($config->version == '1.0.8')//DONT REPLACE WITH USVN_CONFIG_VERSION
        {
            $config->version = '1.0.9';//DONT REPLACE WITH USVN_CONFIG_VERSION
            $config->save();
        }
        else if ($config->version == '1.0.9')//DONT REPLACE WITH USVN_CONFIG_VERSION
        {
        ...
        else if ($config->version == '1.0.11')//DONT REPLACE WITH USVN_CONFIG_VERSION
        {
            $config->version = '1.0.12';//DONT REPLACE WITH USVN_CONFIG_VERSION
            $config->save();
        }
        else
		{
