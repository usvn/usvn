...
class Zend_Gdata_Gapps_UserEntryTest extends PHPUnit_Framework_TestCase
{
    ...
    private function verifyAllSamplePropertiesAreCorrect ($userEntry) {
        $this->assertEquals('https://www.google.com/a/feeds/example.com/user/2.0/SusanJones',
            $userEntry->id->text);
        ...
        $this->assertEquals('https://www.google.com/a/feeds/example.com/user/2.0/SusanJones', $userEntry->getLink('self')->href);
        $this->assertEquals('edit', $userEntry->getLink('edit')->rel);
        $this->assertEquals('application/atom+xml', $userEntry->getLink('edit')->type);
        $this->assertEquals('https://www.google.com/a/feeds/example.com/user/2.0/SusanJones', $userEntry->getLink('edit')->href);
        ...
        $this->assertEquals('https://www.google.com/a/feeds/example.com/nickname/2.0?username=Susy-1321', $userEntry->getFeedLink('http://schemas.google.com/apps/2006#user.nicknames')->href);
        ...
        $this->assertEquals('https://www.google.com/a/feeds/example.com/emailList/2.0?recipient=us-sales@example.com', $userEntry->getFeedLink('http://schemas.google.com/apps/2006#user.emailLists')->href);
