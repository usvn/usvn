	...
	public function getTopMenu()
	{
		...
		if ($this->_identity === null) {
			...
			if ($this->_request->getParam('area') === "project") {
				array_push($menu,
					array(
						"title" => str_replace(USVN_URL_SEP, DIRECTORY_SEPARATOR, $this->_request->getParam('project')),
				...
				array_push($menu,
					array(
						"title" => str_replace(USVN_URL_SEP, DIRECTORY_SEPARATOR, $this->_request->getParam('group')),
