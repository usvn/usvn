 ...
 */
class USVN_modules_svnhooks_models_HooksTest extends USVN_Test_DB {
    /**
    ...
    {
		$hook = new USVN_modules_svnhooks_models_Hooks();
		$hook->postCommit("love", "007", 1, "test", "Ceci est un commit", array(array('M', 'tata'), array('A', 'tutu')));
    }
    ...
    {
		$hook = new USVN_modules_svnhooks_models_Hooks();
		$hook->postLock("love", "007", "tutu", "test");
    }
    ...
    {
		$hook = new USVN_modules_svnhooks_models_Hooks();
		$hook->postUnlock("love", "007", "tutu", "test");
    }
    ...
    {
		$hook = new USVN_modules_svnhooks_models_Hooks();
		$hook->postRevpropChange("love", "007", 1, "test", "svn:log", "M", "message de log");
    }
